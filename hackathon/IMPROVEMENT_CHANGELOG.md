...
The candidate also includes the independent verifier described in Iteration 2. Verification failures currently stop safely; they do not trigger automatic repair until that behavior is implemented and evaluated separately.
